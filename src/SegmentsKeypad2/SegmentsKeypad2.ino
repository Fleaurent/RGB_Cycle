...
void applyPatternB(void) {
  ...
  switch(animationMode) {
    case '0':
      break;
    case '1':
      segmentStrip1.blinkPattern(segmentStrip1.RED(), segmentStrip1.BLUE(), 0x1F, 0x7FFF, 200);  // all segments: 0x7FFF = all pixels
      segmentStrip2.blinkPattern(segmentStrip2.RED(), segmentStrip2.BLUE(), 0x1F, 0x7FFF, 200);  // all segments: 0x7FFF = all pixels
      break;
    case '2':
      segmentStrip1.blinkPattern(segmentStrip1.RED(), segmentStrip1.BLUE(), segmentStrip1.getAllSegments(), 1 << 0, 200);  // all segments: 0x1 = first pixel
      ...
      break;
    case '3':
      segmentStrip1.blinkPattern(segmentStrip1.RED(), segmentStrip1.BLUE(), segmentStrip1.getAllSegments(), 1 << 14, 200);  // all segments: 0x4000 = last pixel 
      segmentStrip2.blinkPattern(segmentStrip2.RED(), segmentStrip2.BLUE(), segmentStrip2.getAllSegments(), 1 << 14, 200);  // all segments: 0x4000 = last pixel 
      break;
    case '4':
      segmentStrip1.blinkPattern(segmentStrip1.RED(), segmentStrip1.BLUE(), segmentStrip1.getAllSegments(), 1 << (segmentStrip1.getLongestSegment() - 1), 200);  // all segments: 0x4000 = last pixel 
      segmentStrip2.blinkPattern(segmentStrip2.RED(), segmentStrip2.BLUE(), segmentStrip2.getAllSegments(), 1 << (segmentStrip2.getLongestSegment() - 1), 200);  // all segments: 0x4000 = last pixel 
      break;
    case '5':
      segmentStrip1.blinkPattern(segmentStrip1.RED(), segmentStrip1.BLUE(), segmentStrip1.getAllSegments(), 0x03C0, 200);  // all segments: 0x03C0 = inner 4 pixels
      segmentStrip2.blinkPattern(segmentStrip2.RED(), segmentStrip2.BLUE(), segmentStrip2.getAllSegments(), 0x03C0, 200);  // all segments: 0x03C0 = inner 4 pixels
      break;
    case '6':
      ...
      segmentStrip2.blinkPattern(segmentStrip2.RED(), segmentStrip2.BLUE(), segmentStrip2.getOddSegments(), segmentStrip2.getOddPixels(), 200);
      break;
    case '7':
      ...
      segmentStrip2.blinkPattern(segmentStrip2.RED(), segmentStrip2.BLUE(), segmentStrip2.getEvenSegments(), segmentStrip2.getEvenPixels(), 200);
      break;
    case '8':
...
void applyPatternC(void) {
  ...
  switch(animationMode) {
    case '0':
      break;
    case '1':
      segmentStrip1.shiftSegments(segmentStrip1.RED(), segmentStrip1.getAllSegments(), 0x1, 1, 250, 50);  // 5 stripes
      segmentStrip2.shiftSegments(segmentStrip2.RED(), segmentStrip2.getAllSegments(), 0x1, 1, 250, 50);  // 5 stripes
      break;
    case '2':
